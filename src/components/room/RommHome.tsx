...
import iconRight from "../../assets/images/chevron_rigth.svg";
...
export const RommHome = () => {
  ...
  const [classFromMovement, setClassFromMovement] = useState(false);
  ...
  const enterRoom = () => {
    ...
    wsServices.onRemoveUserList((socketId: any) => {
